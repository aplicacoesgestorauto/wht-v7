...
interface QueueData {
  ...
  schedules?: Array<{ id: number; weekday: number; startTime: string; endTime: string; }>;
  orderQueue?: number;
...
const UpdateQueueService = async (
  ...
  const { color, name, schedules, greetingMessage, outOfHoursMessage, orderQueue, integrationId, promptId } = queueData;
