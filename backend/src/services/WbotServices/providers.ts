...
import { getBodyMessage, isNumeric, sleep, validaCpfCnpj, sendMessageImage, sendMessageLink, makeid } from "./wbotHelpers";
                    ...
                    if (response.data == 'NULL') {
                      ...
                      try {
                        ...
                        if (qrcode !== null) {
                          ...
                          await sleep(2000)
                          await sendMessageImage(wbot, contact, ticket, linkBoleto as string, "")
                        }
                        ...
                        (async () => {
                          ...
                          await browser.close();
                          await sendMessageLink(wbot, contact, ticket, nomePDF as string, nomePDF);
                        });
